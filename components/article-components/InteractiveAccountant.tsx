...
const getAccountFromNumber = (
  num: number
): { number: number; desc: string; name: string } => {
  ...
  return (
    <AccountantContainer theme={theme}>
      <div>
        ...
        >
          Pocket money {`>`} Accomodation rent
        </button>
      </div>
      <div>
        <InputWrapper theme={theme}>
          ...
          <span>
            <input
              id="is_outcome"
              checked={isOutcome}
              onChange={(e) => setIsOutcome(e.target.checked)}
              type="checkbox"
            />
            <label htmlFor="is_outcome">
              <code>is_outcome</code>
            </label>
          </span>
          <span>
            <input
              id="is_swish"
              checked={isSwish}
              onChange={(e) => setIsSwish(e.target.checked)}
              type="checkbox"
            />
            <label htmlFor="is_swish">
              <code>is_swish</code>
            </label>
          </span>
        </InputWrapper>
